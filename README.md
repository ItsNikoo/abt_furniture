...
- `FirstPage` — промо-блок первой страницы с desktop/mobile изображениями и ссылкой.
...
- `GET /api/sales/` — данные для промо-блоков главной страницы.
...
- `POST|PUT|PATCH|DELETE /api/categories/`, `/api/products/`, `/api/promotions/`, `/api/reviews/`, `/api/materials/`,
  `/api/styles/`, `/api/sales/` — CRUD для авторизованного администратора.

## 12. Пользовательские сценарии

### Клиент сайта

1. Открывает главную страницу и видит промо-блоки, преимущества, категории и форму обратной связи.
