    ...
    <div className="relative flex flex-col w-full items-center justify-center overflow-hidden xl:min-h-[calc(100vh-120px)]">
      ...
      <div className="z-10 flex flex-col items-center justify-center w-full max-w-[1280px] px-4 py-12 gap-4">
        <h1 className="text-3xl md:text-5xl lg:text-7xl font-black leading-tight text-white text-center">
          Прихожие на заказ напрямую от производителя в Москве и МО
        </h1>
        <div>
          <p className="text-base lg:text-lg mt-3 text-white/90 text-center">
            Производим уютные и вместительные прихожие. Множество цветов и материалов на выбор.
          </p>
        </div>
