...
export default function ClientContainer() {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 px-4 sm:px-6 lg:px-0">
          {advantagesList.map((advantage: Advantage, index) => (
            <motion.div
              ...
              text-center p-6 bg-white rounded-2xl
              hover:border-mainPurple border-white border-2
