...
export default function Contacts() {
  return (
    <div className="relative mt-[10px] px-4 md:px-[50px] lg:px-[100px] py-[30px] flex flex-col gap-4 h-[80vh] z-[1] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[url('/background_image.webp')] before:bg-no-repeat before:bg-center before:bg-cover before:opacity-20 before:z-[-1]">
      <div className="mb-6 sm:mb-8">
        <h1 className='text-mainPurple font-extrabold font-overpass text-2xl sm:text-3xl md:text-4xl mb-3'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-3">
            <div className="bg-mainPurple/10 p-2 rounded-full">
              <Phone className="w-5 h-5 text-mainPurple" />
            </div>
        ...
        {/* Email */}
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow md:col-span-2">
          <div className="flex items-center gap-3 mb-3">
