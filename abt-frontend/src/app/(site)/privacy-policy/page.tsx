    ...
    <ContentWrapper>
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-10 my-8">
        ...
        <div className="space-y-7">
          <section>
            <p>
              Настоящая Политика конфиденциальности и обработки персональных данных (далее — «Политика») разработана в
              соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок
              обработки персональных данных и меры по обеспечению безопасности персональных данных, осуществляемые ИП
              «Колесникова Ольга Владимировна» (далее — «Оператор»).
            </p>
          </section>
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                Железнодорожный, Керамическая, 2Б, самостоятельно или совместно с другими лицами организующее и (или)
                осуществляющее обработку персональных данных, а также определяющее цели обработки персональных данных,
              ...
              <li>
                <b>Конфиденциальность персональных данных</b> — обязательное для соблюдения Оператором или иным
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>предоставлять субъекту персональных данных по его запросу информацию, касающуюся обработки его
                персональных данных;
              </li>
              <li>отвечать на обращения и запросы субъектов персональных данных и их законных представителей в
                соответствии с требованиями закона;
              </li>
              <li>сообщать в уполномоченный орган по защите прав субъектов персональных данных (Роскомнадзор) по его
                запросу необходимую информацию в течение 10 дней с даты получения такого запроса.
              </li>
            </ul>
          </section>
          <section>
            ...
            <p>
              ...
              заполняя формы на Сайте [Адрес вашего сайта]:
            </p>
            ...
            <p>
              ...
              При посещении Сайта автоматически собираются и обрабатываются данные о использовании Сайта (cookies,
              данные об IP-адресе, типе браузера, времени посещения и т.д.). Эти данные являются обезличенными и
              используются для анализа посещаемости и улучшения работы Сайта.
            </p>
          </section>
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Направление Пользователю информации о товарах, услугах, акциях и специальных предложениях (только при
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Согласие субъекта персональных данных, выраженное путем проставления отметки в специальном чек-боксе
                на Сайте перед отправкой формы.
              </li>
          ...
          <section>
            ...
            <p>
              ...
              путем направления соответствующего запроса на электронную почту Оператора.<br/>
              После отзыва согласия или достижения целей обработки персональные данные подлежат уничтожению или
              обезличиванию.
            </p>
          </section>
          <section>
            ...
            <p>Оператор обязуется не передавать полученные персональные данные третьим лицам, за исключением следующих
              случаев:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>По запросу уполномоченных государственных органов РФ в случаях, предусмотренных законодательством
                РФ.
              </li>
              <li>Третьим лицам, привлекаемым Оператором для оказания услуг и выполнения обязательств перед
                Пользователем (например, хостинг-провайдеры, службы доставки). Такие третьи лица обязаны обеспечивать
                конфиденциальность персональных данных и не могут использовать их в иных целях, кроме тех, которые
                указаны в договоре с Оператором.
              </li>
            </ul>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              Железнодорожный, Керамическая, 2Б.
            </p>
          </section>
          <section>
            ...
            <p>
              ...
              Оператор вправе вносить изменения в настоящую Политику. При внесении изменений в актуальной редакции
              указывается дата последнего обновления. Новая редакция Политики вступает в силу с момента ее размещения на
              Сайте.
            </p>
          </section>
        </div>
