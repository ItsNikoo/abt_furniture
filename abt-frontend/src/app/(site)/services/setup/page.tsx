        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-4">
              ...
              <br />
              Наши опытные мастера быстро и аккуратно соберут и установят мебель на месте, учитывая все нюансы помещения. Мы используем только профессиональный инструмент и строго следуем технологии монтажа.
            </p>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
              <span className="font-bold">Всё под контролем</span>
              <br />
              После установки мы обязательно проверим работу всех механизмов, дверей и ящиков, чтобы вы были уверены в надёжности и долговечности вашей мебели.
            </p>
          </div>
        </div>
        {/* CTA Section */}
        <div className="mt-8 sm:mt-12 text-center">
          <div className="bg-gradient-to-r from-mainPurple to-mainPurple/80 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 text-white shadow-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg opacity-90 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto">
              Свяжитесь с нами — мы подробно расскажем о процессе установки, сроках и гарантии, а также поможем организовать всё максимально удобно для вас!
            </p>
